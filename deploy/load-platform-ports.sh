...
_platform_ports_keys='AUTH_PORTAL_UI_PORT AUTH_CONSOLE_UI_PORT LANGCHAIN4J_UI_PORT RECSYS_UI_PORT DROOLS_UI_PORT RISK_UI_PORT WORKFLOW_UI_PORT RECON_UI_PORT BENEFIT_UI_PORT MARKETING_UI_PORT TRADE_UI_PORT WMS_UI_PORT OA_UI_PORT'
